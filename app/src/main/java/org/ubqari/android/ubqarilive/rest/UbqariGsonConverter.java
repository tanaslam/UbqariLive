 ...
 */
public class UbqariGsonConverter extends AbstractHttpMessageConverter<Object> {
     ...
     */
    public UbqariGsonConverter(boolean serializeNulls) {
     ...
     */
    public UbqariGsonConverter(Gson gson) {
